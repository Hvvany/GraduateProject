...
void High_Speed_Sensing_Mode(){
    ...
    while(main_distance<=250||sub1_distance<=250||sub2_distance<=250){
      ...
      else if(sub2_distance<=250&&sub1_distance>250){       //오른쪽 보조 초음파 동작
        angle = angle - 15;
        Main_Distance_Mode();
        Sub1_Distance_Mode();
        Sub2_Distance_Mode();
      }
      else if(sub1_distance<=250&&sub2_distance<=250){      //왼쪽, 오른쪽 모두 센싱시 왼쪽으로 돌리기 동작
        angle = angle + 15;
        Main_Distance_Mode();
        Sub1_Distance_Mode();
        Sub2_Distance_Mode();
...
void Far_Area_Detecting_Mode()
{
    unsigned long LowLevelTime = pulseIn(mainECHO, LOW);
      ...
      float i=0;
        ...
        else if(5<=i<10){                                 //y값이 0.5씩 감소하며 측정
          angle = (180/pi)*atan(y1/far);
          angle = angle*1.14;
          servo.write(angle);
          delay(50);
...
void Close_Area_Detecting_Mode()
{
    ...
    while(times<=2){
        ...
        else if(3<=i<5){                                  //y2.5미터 구간에서 x값이 1씩 감소하며 측정
          angle = (180/pi)*atan(y1/x1);
          angle = angle*1.14;
          servo.write(angle);
          delay(50);
        ...
        else if(5<=i<8){                                  //y2.5미터 구간에서 x값이 1씩 증가하며 측정
          angle = (180/pi)*atan(y1/x1);
          angle = angle*1.14;
          servo.write(angle);
          delay(50);
        ...
        else if(8<=i<10){                                  //x2.5미터 구간에서 y값이 1씩 감소하며 측정
          angle = (180/pi)*atan(y1/x1);
          angle = angle*1.14;
          servo.write(angle);
          delay(50);
...
void Print_Mode(){
          ...
          if(x>4){
            ...
            if(0<y<=0.5){
              Serial.println("현재 좌표는 1행 5열 입니다.");
            }
            else if(0.5<y<=1){
              Serial.println("현재 좌표는 2행 5열 입니다.");
            }
            else if(1<y<=1.5){
              Serial.println("현재 좌표는 3행 5열 입니다.");
            }
            else if(1.5<y<=2){
              Serial.println("현재 좌표는 4행 5열 입니다."g);
            }
            else if(2<y<=2.5){
              Serial.println("현재 좌표는 5행 5열 입니다.");
            }
            else if(2.5<y<=3){
              Serial.println("현재 좌표는 6행 5열 입니다.");
            }
          }
            ...
            n="4";
            if(0<y<=0.5){
              Serial.println("현재 좌표는 1행 4열 입니다.");
            }
            else if(0.5<y<=1){
              Serial.println("현재 좌표는 2행 4열 입니다.");
            }
            else if(1<y<=1.5){
              Serial.println("현재 좌표는 3행 4열 입니다.");
            }
            else if(1.5<y<=2){
              Serial.println("현재 좌표는 4행 4열 입니다.");
            }
            else if(2<y<=2.5){
              Serial.println("현재 좌표는 5행 4열 입니다.");
            }
            else if(2.5<y<=3){
              Serial.println("현재 좌표는 6행 4열 입니다.");
            }
          }
            ...
            n="3";
            if(0<y<=1){
              Serial.println("현재 좌표는 1행 3열 입니다.");
            }
            else if(1<y<=2){
              Serial.println("현재 좌표는 2행 3열 입니다.");
            }
            else if(2<y<=3){
              Serial.println("현재 좌표는 3행 3열 입니다.");
            }
          }
            ...
            n="2";
            if(0<y<=1){
              Serial.println("현재 좌표는 1행 2열 입니다.");
            }
            else if(1<y<=2){
              Serial.println("현재 좌표는 2행 2열 입니다.");
            }
            else if(2<y<=3){
              Serial.println("현재 좌표는 3행 2열 입니다.");
            }
          }
            ...
            n="1";
            if(0<y<=1){
              Serial.println("현재 좌표는 1행 1열 입니다.");
            }
            else if(1<y<=2){
              Serial.println("현재 좌표는 2행 1열 입니다.");
            }
            else if(2<y<=3){
              Serial.println("현재 좌표는 3행 1열 입니다.");
            }
          }
} 
